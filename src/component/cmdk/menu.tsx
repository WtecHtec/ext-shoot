...
import {ActionMeta, SUB_ITME_ACTIONS, getSubItemActionMap} from '~utils/actions';
import {
    getExtensionAll,
    handleAddRecently,
                ...
                <div cmdk-raycast-footer="">
                    ...
                    <button cmdk-raycast-open-trigger="" onClick={ onHandleUpdate }>
                        { updateStatus === 1 ? <UpdateInfoIcon></UpdateInfoIcon> : (
                            updateStatus === 2 ?
                                <LineSpinnerIcon></LineSpinnerIcon> : null
                        ) }
                        Update
                        <kbd>⌘</kbd>
                        <kbd>U</kbd>
    ...
    return <Dialog.Root open={ open } onOpenChange={ onOpenChange }>
        <Dialog.Portal container={ container }>
            ...
            <Dialog.Content className="DialogContent">
                <Tabs.Root className="TabsRoot" defaultValue={ tabValue }
                           value={ tabValue } onValueChange={ setTabValue }>
                    ...
                    <Tabs.Content className="TabsContent" value="add">
                        ...
                        <fieldset className="Fieldset">
                            <input placeholder="snapshot name (min len 2)" minLength={ 2 }
                                   maxLength={ 12 } className="Input" value={ snapName }
                                   onInput={ onInput }/>
                        </fieldset>
                    </Tabs.Content>
                    <Tabs.Content className="TabsContent" value="replace">
                        ...
                        <Select.Root value={ snapId } onValueChange={ setSnapId }>
                            <Select.Trigger className="SelectTrigger" aria-label="Food">
                                <Select.Value
                                    placeholder={ snapshots.length > 0 ? 'Select a Snapshot' : 'Snapshot Empty' }/>
                                <Select.Icon className="SelectIcon">
                                    <ChevronDownIcon/>
                                </Select.Icon>
                            </Select.Trigger>
