...
export const getExtensionAll = (): Promise<[null | Error, ExtItem[] | null]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: 'get_extensions' })
      .then(async (response) => {
...
export const handleOpenOtions = (extensionId: string): Promise<[null | Error, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: 'open_options_page', extensionId })
      .then(async (response) => {
...
export const handleOpenExtensionDetails = (extensionId: string, extName: string): Promise<[null | Error, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: 'open_extension_details', extensionId, extName })
      .then(async (response) => {
        resolve([null, response]);
      })
      .catch((err) => {
...
export const handleGetExtensionIcon = (extensionId: string, iconSize: string): Promise<[null | Error, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: 'get_extension_icon', extensionId, iconSize })
      .then(async (response) => {
        resolve([null, response]);
      })
      .catch((err) => {
...
export const handleExtUpdateDone = () => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: EXT_UPDATE_DONE })
      .then(async (response) => {
        resolve([null, response]);
      })
      .catch((err) => {
...
export const handleExtFavoriteDone = (id, value) => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_FAVORITE, id, value })
      .then(async (response) => {
        resolve([null, response]);
      })
      .catch((err) => {
...
export const handleOpenRecently = (pendingUrl) => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_RECENTLY_OPEN, pendingUrl })
      .then(async (response) => {
        resolve([null, response]);
      })
      .catch((err) => {
...
export const handleGetSnapshots = (): Promise<[null | Error, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_GET_SNAPSHOTS })
      .then(async (response) => {
...
export const handleCreateSnapshots = (id, name, extIds) => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_SNAPSHOT_CREATE, id, name, extIds })
      .then(async (response) => {
        resolve([null, response]);
      })
      .catch((err) => {
...
export const handlePluginStatus = (extensionId, status) => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: 'enable_extension', extensionId, status })
      .then(async (response) => {
        resolve([null, response]);
      })
      .catch((err) => {
...
export const handleUninstallPlugin = (extensionId): Promise<[any, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: 'uninstall_extension', extensionId })
      .then(async (response) => {
...
export const handleGetAllCommands = (): Promise<[any, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_GET_COMMANDS })
      .then(async (response) => {
...
export const handleGetRecentlys = (): Promise<[any, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_GET_RECENTLYS })
      .then(async (response) => {
...
export const handleAddRecently = (recently: RecentlyItem): Promise<[any, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_ADD_RECENTLYS, params: recently })
      .then(async (response) => {
...
export const handleSoloRun = (extId): Promise<[any, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_SOLO_RUN, extId })
      .then(async (response) => {
        resolve([null, response.status]);
      })
      .catch((err) => {
...
export const handleCreateTab = (pageUrl, active = true): Promise<[any, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_CREATE_TAB, pageUrl, active })
      .then(async (response) => {
        resolve([null, response.status]);
      })
      .catch((err) => {
...
export const getSnapSeekData = (): Promise<[any, any]> => {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_GET_SNAPSEEK })
      .then(async (data) => {
        if (data && data.data) {
...
export function saveSnapSeekData(data) {
  return new Promise((resolve) => {
    chrome.runtime
      .sendMessage({ action: AC_SET_SNAPSEEK, data })
      .then(async () => {
        resolve([null, {}]);
      })
      .catch((err) => {
